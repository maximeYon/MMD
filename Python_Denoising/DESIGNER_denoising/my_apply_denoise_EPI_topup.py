...
Signalup, Sigmaup,Nparametersup = mpden.denoise(dwiup, kernel=[15,15,1],patchsize=125,shrinkage='frobenius')
Signaldown, Sigmadown,Nparametersdown = mpden.denoise(dwidown, kernel=[15,15,1],patchsize=125,shrinkage='frobenius')
