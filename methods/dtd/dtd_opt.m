...
opt.dtd = msf_ensure_field(opt.dtd, 'comp_isomax',[2e-9; 7e-10; 3e-10]);
opt.dtd = msf_ensure_field(opt.dtd, 'comp_isomin',[7e-10; 2e-10; 10e-11]);
opt.dtd = msf_ensure_field(opt.dtd, 'comp_ratiomax',[3; 200; 3]);
opt.dtd = msf_ensure_field(opt.dtd, 'comp_ratiomin',[1/3; 20; 1/3]);
