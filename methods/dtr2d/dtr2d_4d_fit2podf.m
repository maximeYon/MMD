...
odf_s.kappa = 1/tan(ODindex*pi/2);
    ...
    function [odf_w, odf_diso, odf_sqddelta, odf_r2] = dtds2podf(odf_s, dtds)
...
%                        if n>0
                            ...
                            sqddelta_vox = squeeze(dtds.sqddelta(ni,nj,nk,:));
...
for nbin = 1:numel(opt.dtr2d.bin_disomax)
    ...
    [odf_w, odf_diso, odf_sqddelta, odf_r2] = dtds2podf(odf_s, dtds_temp);
