...
EG.handles.h_analysis_redo_button = uicontrol('style','pushbutton', ...
    'parent', h, ...
    'units', 'pixels', ...
    'position', [left bottom width height], ...
    'string', 'Redo', ...
    'tag', EG.t_ANALYSIS_REDO_BUTTON, ...
    'callback', @mgui_roi_gui_callback);
...
EG.handles.h_analysis_terminology_popup = uicontrol('style','popupmenu', ...
    'parent', h, ...
    'units', 'pixels', ...
    'position', [left bottom width height], ...
    'string', 'terminology', ...
    'tag', EG.t_ANALYSIS_TERMINOLOGY_POPUP, ...
    'callback', @mgui_roi_gui_callback);
