...
nii_fns{1} = [home_path filesep 'ProcessingPV360' filesep 'data' filesep data_path filesep mdd_path filesep 'nii_xps' filesep 'denoised' filesep];
nii_fns_out{1} = [home_path filesep 'ProcessingPV360' filesep 'data' filesep data_path filesep mdd_path filesep 'nii_xps' filesep];
...
opt = mdm_mrtrix_opt;
[status1, result1] = my_mdm_mrtrix_degibbs([nii_fns{1} 'dataUp.nii.gz'], [nii_fns_out{1} 'dataUp.nii.gz'], opt);
[status2, result2] = my_mdm_mrtrix_degibbs([nii_fns{1} 'dataDown.nii.gz'], [nii_fns_out{1} 'dataDown.nii.gz'], opt);
