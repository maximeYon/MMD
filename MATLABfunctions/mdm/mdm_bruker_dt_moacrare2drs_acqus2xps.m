function xps = mdm_bruker_dt_moacrare2drs_acqus2xps(data_path, xps_fn)
% function xps = mdm_bruker_dt_axderare2drs_acqus2xps(data_path, xps_fn)
%
...
tT2W = .5e-6*NMRacqus.p11 + 7*NMRacqus.d32 + 2*NMRacqus.d22 + NMRacqus.vdT2 + NMRacqus.d34 + ...
    2*NMRacqus.d3 + 2*NMRacqus.d4 + 1e-6*NMRacqus.p12 + NMRacqus.d35 + 0.5*NMRacqus.aq;
tT1R = zeros(td1,1);
