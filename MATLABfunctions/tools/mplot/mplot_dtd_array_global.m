function mplot_dtd_array_global(paths, opt)
% function mplot_dtd_array_global(paths, opt)
...
fig_fn = fullfile(paths.figs,'Figure4_DTDarray');
msf_mkdir(paths.figs);
eval(['print ' fig_fn ' -loose -dpng -r600'])
...
fig_fn = fullfile(paths.figs,'Figure4_DTDglobal');
msf_mkdir(paths.figs);
eval(['print ' fig_fn ' -loose -dpng -r1200'])
