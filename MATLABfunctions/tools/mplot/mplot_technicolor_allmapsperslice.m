function mplot_technicolor_allmapsperslice(method, dps, slices_path, clim)
% function mplot_technicolor_allmapsperslice(method, dps, slices_path, clim)
...
msf_mkdir(fullfile(slices_path,'pdfs'));
...
for nk = 1:sz(3)
    ...
    fig_name = ['technicolor_slice' num2str(nk)];
    print(fullfile(slices_path,'pdfs',fig_name),'-loose','-dpdf')
    %savefig(gcf,fullfile(slices_path,'matfigs',fig_name),'compact')
end
