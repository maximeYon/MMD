...
out_path = 'C:\Users\Administrateur\Mon_Drive\Matlab\MATLABfunctions\md-dmri\acq\bruker\Paravision360\500_Lund\DOR_shapes';
...
for nshape = 1:length(dorratios)
    ...
    %% 2023 Maxime Yon, normalization should not be here but in protocol design
