...
clearvars;close all;
xlsx_name = 'DOR_protocol_short_VerylowFrq_3shape_303'; % 'List_testBvalue'
...
out_path = 'C:\Users\Administrateur\Mon_Drive\Matlab\MATLABfunctions\md-dmri\acq\bruker\Paravision360\500_Lund\DOR_list';
framework_path = fileparts(fileparts(fileparts(run_path)));
pa_path = fullfile(framework_path,'tools','uvec','repulsion_angles');

%% Define parameters
randomised =0; % randomized option

% Gradients and shapes constant
PVM_GradCalConst = 125566; % Lund
gamma1H = 26.75e7;
param.Gmax= PVM_GradCalConst*2*pi/gamma1H*1e3;
param.EffiFactor = [0.00534340314065705,0.00267377060668861,0.00160424360538068,0.000832765026019457,0.000499444991877096,0.000319659877592425]; %1000 points
% tau = 4;
