...
% Work in progress
%
addpath(genpath('C:\Users\Administrateur\Mon_Drive\Matlab\MATLABfunctions'));

% Define timing parameters relative to a total echo time = 1
% Double cone parameters
% q-vector buildup parameters

out_path = 'C:\Users\Administrateur\Mon_Drive\Matlab\MATLABfunctions\md-dmri\acq\bruker\Paravision360\7T_Kuopio\DOR_shapes';
% out_path = '/opt/PV-360.1.1/prog/curdir/maxime/ParaVision/exp/lists/gp';
% dorratios = 0;
dorratios = [0 1 2 3 4 5];

epsilon_up = .03; plateau = 0; epsilon_down = 4*epsilon_up; % orig
