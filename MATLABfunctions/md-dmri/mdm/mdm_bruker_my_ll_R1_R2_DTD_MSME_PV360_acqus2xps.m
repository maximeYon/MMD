function xps = mdm_bruker_my_ll_R1_R2_DTD_MSME_PV360_acqus2xps(data_path, xps_fn, rps)
...
%% Compute baselevel parameters
g0 = gradAmpl(0+1);
p0 = Pulses(0+1)*1e-6;
d2 = Delays(2+1);
g2 = gradAmpl(2+1);
g7 = gradAmpl(7+1);
d1 = Delays(1+1); %ramp (rise+igwt) +TEfillDelay
...
d3 = Delays(3+1); % rise time
p1 = Pulses(1+1)*1e-6;
d5 = Delays(5+1);%EncGradDur
g8 = gradAmpl(8+1);
g3 = gradAmpl(3+1);
d6 = Delays(6+1); %ramp + TEFilledelay2
