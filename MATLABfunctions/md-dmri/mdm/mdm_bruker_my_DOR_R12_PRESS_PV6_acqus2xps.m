function xps = mdm_bruker_my_DOR_R12_PRESS_PV6_acqus2xps(data_path, xps_fn, rps)
...
Ndt_postref = Ndt_p3half + Ndt_d6 + Ndt_d8 + Ndt_d4 +...
    ...
    Ndt_d9 + Ndt_u20 + Ndt_d10 + Ndt_d4 + Ndt_d6 + Ndt_p4half + ...
...
Seq_part(1,:) = Ndt_p1half + Ndt_d6 + Ndt_d7 + Ndt_AddTE;
...
Seq_part(5,:) = Seq_part(4,:) + Ndt_d9 + Ndt_u20 + Ndt_d10 + Ndt_d4 + Ndt_d6 + Ndt_p4half + Ndt_p4half + Ndt_d6 + Ndt_d10 + Ndt_d11 + Ndt_u10 + Ndt_u10;
...
G.exc_x = [g1*ones(Ndt_p1half,1);g1*ones(Ndt_d6,1); g1/2*ones(Ndt_d4,1); 0*ones(Ndt_d7minusd4,1)]*unit2si;
G.exc_y = [0*ones(Ndt_p1half,1);0*ones(Ndt_d6,1); 0*ones(Ndt_d4,1); 0*ones(Ndt_d7minusd4,1)]*unit2si;
G.exc_z = [0*ones(Ndt_p1half,1);0*ones(Ndt_d6,1); 0*ones(Ndt_d4,1); 0*ones(Ndt_d7minusd4,1)]*unit2si;
...
G.acq_x = [0*ones(Ndt_d9,1); 0*ones(Ndt_u20,1); g8*ones(Ndt_d10,1); 0*ones(Ndt_d4,1);0*ones(Ndt_d6,1); 0*ones(Ndt_p4half,1); 0*ones(Ndt_p4half,1);0*ones(Ndt_d6,1);-1*g8*ones(Ndt_d10,1);0*ones(Ndt_d11,1); 0*ones(Ndt_u10,1); 0*ones(Ndt_u10,1)]*unit2si;
G.acq_y = [0*ones(Ndt_d9,1); 0*ones(Ndt_u20,1); g9*ones(Ndt_d10,1); 0*ones(Ndt_d4,1);0*ones(Ndt_d6,1); 0*ones(Ndt_p4half,1); 0*ones(Ndt_p4half,1);0*ones(Ndt_d6,1);-1*g9*ones(Ndt_d10,1);0*ones(Ndt_d11,1); 0*ones(Ndt_u10,1); 0*ones(Ndt_u10,1)]*unit2si;
G.acq_z = [0*ones(Ndt_d9,1); 0*ones(Ndt_u20,1); g10*ones(Ndt_d10,1); 0*ones(Ndt_d4,1);g3*ones(Ndt_d6,1); g3*ones(Ndt_p4half,1); -1*g3*ones(Ndt_p4half,1);-1*g3*ones(Ndt_d6,1);-1*g10*ones(Ndt_d10,1);0*ones(Ndt_d11,1); 0*ones(Ndt_u10,1); 0*ones(Ndt_u10,1)]*unit2si;
