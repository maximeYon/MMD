...
for nexp = 1:length(expno)
    ...
    ParaToList = {'pulprog','ACQ_pipe_status','PVM_EchoTime','PVM_RepetitionTime','DwLoopOrder','DwNAmplitudes','DwGradShapeStrArr','DwGradShapeStrArr1','DwGradShapeStrArr2','DwNDirs','DwGradDur','DwGradDur1','DwGradDur2','DwGradTsep','rg'};
