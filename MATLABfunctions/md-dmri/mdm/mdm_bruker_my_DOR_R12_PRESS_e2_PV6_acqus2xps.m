...
Seq_part(3,:) = Seq_part(2,:) + Ndt_d10 + Ndt_d4 + Ndt_d6 + Ndt_p4half + Ndt_p4half + Ndt_d6 + Ndt_d10 + Ndt_d4;
Seq_part(4,:) = Seq_part(3,:) + (Ndt_DwD1 + Ndt_DwD4 +Ndt_DwD1).*DiffusionExperimentList + Ndt_AddTE;
Seq_part(5,:) = Seq_part(4,:) + Ndt_d11 + Ndt_u10 + Ndt_u10;
...
G.ref_x = [g8*ones(Ndt_d10,1); 0*ones(Ndt_d4,1);0*ones(Ndt_d6,1); 0*ones(Ndt_p4half,1); 0*ones(Ndt_p4half,1);0*ones(Ndt_d6,1);g8*ones(Ndt_d10,1);0*ones(Ndt_d4,1)]*unit2si;
G.ref_y = [g9*ones(Ndt_d10,1); 0*ones(Ndt_d4,1);0*ones(Ndt_d6,1); 0*ones(Ndt_p4half,1); 0*ones(Ndt_p4half,1);0*ones(Ndt_d6,1);g9*ones(Ndt_d10,1);0*ones(Ndt_d4,1)]*unit2si;
G.ref_z = [g10*ones(Ndt_d10,1); 0*ones(Ndt_d4,1);g3*ones(Ndt_d6,1); g3*ones(Ndt_p4half,1); g3*ones(Ndt_p4half,1);g3*ones(Ndt_d6,1);g10*ones(Ndt_d10,1);0*ones(Ndt_d4,1)]*unit2si;

G.acq_x = [0*ones(Ndt_d11,1); 0*ones(Ndt_u10,1); 0*ones(Ndt_u10,1)]*unit2si;
G.acq_y = [0*ones(Ndt_d11,1); 0*ones(Ndt_u10,1); 0*ones(Ndt_u10,1)]*unit2si;
G.acq_z = [0*ones(Ndt_d11,1); 0*ones(Ndt_u10,1); 0*ones(Ndt_u10,1)]*unit2si;
