function xps = mdm_bruker_my_ll_R12_DTD_RAREst_PV360_acqus2xps_oldBvalues(data_path, xps_fn, rps)
...
G.acq_x = cat(1,G.acq_x,[SignBpulse*0*ones(Ndt_d8,1);SignBpulse*0*ones(Ndt_p1half,1);SignApulse*0*ones(Ndt_p1half,1);SignApulse*0*ones(Ndt_d4,1);SignApulse*0*ones(Ndt_d8,1);SignApulse*0*ones(Ndt_d3,1);SignApulse*ReadShape*ones(Ndt_d10div2,1)]*unit2si);
G.acq_y = cat(1,G.acq_y,[SignBpulse*0*ones(Ndt_d8,1);SignBpulse*0*ones(Ndt_p1half,1);SignApulse*0*ones(Ndt_p1half,1);SignApulse*0*ones(Ndt_d4,1);SignApulse*0*ones(Ndt_d8,1);SignApulse*0*ones(Ndt_d3,1);SignApulse*PhaseShape*ones(Ndt_d10div2,1)]*unit2si);
G.acq_z = cat(1,G.acq_z,[SignBpulse*g3*ones(Ndt_d8,1);SignBpulse*g3*ones(Ndt_p1half,1);SignApulse*g3*ones(Ndt_p1half,1);SignApulse*g3/2*ones(Ndt_d4,1);SignApulse*0*ones(Ndt_d8,1);SignApulse*0*ones(Ndt_d3,1);SignApulse*SliceShape*ones(Ndt_d10div2,1)]*unit2si);
