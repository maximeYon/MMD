function xps = mdm_bruker_my_ll_R12_DTD_RARE_PV360_acqus2xps(data_path, xps_fn, rps)
...
g4 = gradAmpl(4+1);
g5 = gradAmpl(5+1);
g6 = gradAmpl(6+1); g6 = 0; %force center of Kspace
g7 = gradAmpl(7+1);
g8 = gradAmpl(8+1);
% pulse duration
p0 = Pulses(0+1)*1e-6;
...
G.exc_x = [0*ones(Ndt_p0half,1); 0*ones(Ndt_d3,1)]*unit2si;
G.exc_y = [0*ones(Ndt_p0half,1); 0*ones(Ndt_d3,1)]*unit2si;
G.exc_z = [g0*ones(Ndt_p0half,1); g0/2*ones(Ndt_d3,1)]*unit2si;
...
G.acq_x = [0*ones(Ndt_d3,1); 0*ones(Ndt_d11,1); g2*ones(Ndt_d2,1);0*ones(Ndt_d1,1)]*unit2si; % decrease grad ramp during d1;
G.acq_y = [0*ones(Ndt_d3,1); 0*ones(Ndt_d11,1); 0*ones(Ndt_d2,1);0*ones(Ndt_d1,1)]*unit2si;
G.acq_z = [0*ones(Ndt_d3,1); 0*ones(Ndt_d11,1); g7*ones(Ndt_d2,1);0*ones(Ndt_d1,1)]*unit2si;
...
G.acq_y = cat(1,G.acq_y,[SignBpulse*0*ones(Ndt_d3,1);SignBpulse*0*ones(Ndt_p1half,1);SignApulse*0*ones(Ndt_p1half,1);SignApulse*g4*ones(Ndt_d5,1);SignApulse*0*ones(Ndt_d6,1);SignApulse*0*ones(Ndt_denab,1);SignApulse*0*ones(Ndt_Aq,1);SignApulse*0*ones(Ndt_d6,1);SignApulse*g4*ones(Ndt_d5,1)]*unit2si);
G.acq_z = cat(1,G.acq_z,[SignBpulse*g0*ones(Ndt_d3,1);SignBpulse*g0*ones(Ndt_p1half,1);SignApulse*g0*ones(Ndt_p1half,1);SignApulse*g3-g6*ones(Ndt_d5,1);SignApulse*0*ones(Ndt_d6,1);SignApulse*0*ones(Ndt_denab,1);SignApulse*0*ones(Ndt_Aq,1);SignApulse*0*ones(Ndt_d6,1);SignApulse*g3+g6*ones(Ndt_d5,1)]*unit2si);
end
ind_echo = ind_echo+1;
    if  mod(ind_echo,2) % Odd
    SignBpulse = 1; SignApulse = -1;
...
G.acq_y = cat(1,G.acq_y,[SignBpulse*0*ones(Ndt_d3,1);SignBpulse*0*ones(Ndt_p1half,1);SignApulse*0*ones(Ndt_p1half,1);SignApulse*g4*ones(Ndt_d5,1);SignApulse*0*ones(Ndt_d6,1);SignApulse*0*ones(Ndt_denab,1);SignApulse*0*ones(Ndt_AqDiv2,1)]*unit2si);
G.acq_z = cat(1,G.acq_z,[SignBpulse*g0*ones(Ndt_d3,1);SignBpulse*g0*ones(Ndt_p1half,1);SignApulse*g0*ones(Ndt_p1half,1);SignApulse*g3-g6*ones(Ndt_d5,1);SignApulse*0*ones(Ndt_d6,1);SignApulse*0*ones(Ndt_denab,1);SignApulse*0*ones(Ndt_AqDiv2,1)]*unit2si);
