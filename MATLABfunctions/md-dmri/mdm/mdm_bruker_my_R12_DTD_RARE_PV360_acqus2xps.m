function xps = mdm_bruker_my_R12_DTD_RARE_PV360_acqus2xps(data_path, xps_fn, rps)
...
G.exc_z = [g0*ones(Ndt_p0half,1); g0/2*ones(Ndt_d3,1); g12*ones(Ndt_d12,1); 0*ones(Ndt_d3,1)]*unit2si;
