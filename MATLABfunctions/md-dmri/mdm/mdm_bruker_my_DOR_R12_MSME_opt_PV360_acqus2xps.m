function xps = mdm_bruker_my_DOR_R12_MSME_opt_PV360_acqus2xps(data_path, xps_fn, rps)
...
g0_exc = - g7*Ndt_d2/(Ndt_p0half+Ndt_d3/2);
...
G.exc_z = [g0_exc*ones(Ndt_p0half,1); g0_exc/2*ones(Ndt_d3,1); g7*ones(Ndt_d2,1); 0*ones(Ndt_d1,1)]*unit2si;

if strcmp(RefoCrusher,'yes')==1
    G.ref_x = [0*ones(Ndt_d22,1);0*ones(Ndt_d3,1); 0*ones(Ndt_p1half,1); 0*ones(Ndt_p1half,1);0*ones(Ndt_d22,1);0*ones(Ndt_d3,1); -g8*ones(Ndt_d5,1); 0*ones(Ndt_d6,1)]*unit2si;
    G.ref_y = [0*ones(Ndt_d22,1);0*ones(Ndt_d3,1); 0*ones(Ndt_p1half,1); 0*ones(Ndt_p1half,1);0*ones(Ndt_d22,1);0*ones(Ndt_d3,1); 0*ones(Ndt_d5,1); 0*ones(Ndt_d6,1)]*unit2si;
    G.ref_z = [g22*ones(Ndt_d22,1);g0/2*ones(Ndt_d3,1); g0*ones(Ndt_p1half,1); g0*ones(Ndt_p1half,1);g22*ones(Ndt_d22,1);g0/2*ones(Ndt_d3,1); 0*ones(Ndt_d5,1); 0*ones(Ndt_d6,1)]*unit2si;
else
    G.ref_x = [0*ones(Ndt_d3,1); 0*ones(Ndt_p1half,1); 0*ones(Ndt_p1half,1);0*ones(Ndt_d3,1); -g8*ones(Ndt_d5,1); 0*ones(Ndt_d6,1)]*unit2si;
    G.ref_y = [0*ones(Ndt_d3,1); 0*ones(Ndt_p1half,1); 0*ones(Ndt_p1half,1);0*ones(Ndt_d3,1); 0*ones(Ndt_d5,1); 0*ones(Ndt_d6,1)]*unit2si;
    G.ref_z = [g0/2*ones(Ndt_d3,1); g0*ones(Ndt_p1half,1); g0*ones(Ndt_p1half,1);g0/2*ones(Ndt_d3,1); 0*ones(Ndt_d5,1); 0*ones(Ndt_d6,1)]*unit2si;
end

G.acq_x = [g5/2*(Ndt_d3/Ndt_denab)*ones(Ndt_denab,1); g5*ones(Ndt_rdepa,1); g5*ones(Ndt_aqqhalf,1)]*unit2si;
