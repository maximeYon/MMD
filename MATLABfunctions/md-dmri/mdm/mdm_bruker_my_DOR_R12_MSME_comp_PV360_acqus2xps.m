function xps = mdm_bruker_my_DOR_R12_MSME_comp_PV360_acqus2xps(data_path, xps_fn, rps)
...
u11 = 0.000011;
EffecectiveTRcalc = d0+d10+u11+AddTRList+d9+d3+(p0*(1-ExcPulse1_Rpfac));
...
Ndt_preref = Ndt_p0half + Ndt_d2 + Ndt_d1 + ...
    ...
    Ndt_d3 + Ndt_p1half;
Ndt_postref = Ndt_p1half + (Ndt_DwD1 + Ndt_DwD4 +Ndt_DwD1).*DiffusionExperimentList + Ndt_AddTE +  ...
    Ndt_d5 + Ndt_d6 + ...
    Ndt_denab + Ndt_rdepa + Ndt_aqqhalf;
Ndt_tot = Ndt_preref + Ndt_postref;

%% Create sequences part for b-calculation
Seq_part(1,:) = Ndt_p0half + Ndt_d2 + Ndt_d1 + Ndt_AddTE;
