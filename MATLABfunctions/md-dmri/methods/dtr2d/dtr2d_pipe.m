...
if (opt.do_datamfs2fitchisq)
    [fit_fn,chisq_fn] = mio_datamfs2fitchisq(@dtr2d_1d_fit2data, s, paths.mfs_fn, paths.fit_fn, paths.chisq_fn, opt);
end
