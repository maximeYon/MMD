function fn = dti_nls_pipe(s, paths, opt)
% function fn = dti_nls_pipe(s, paths, opt)
%
% s     - input structure
...
if (opt.do_data2fit)
    mdm_data2fit(@dti_nls_4d_data2fit, s, paths.mfs_fn, opt);
end
if (opt.do_fit2param)
    mdm_fit2param(@dti_nls_4d_fit2param, paths.mfs_fn, paths.dps_fn, opt);
end
