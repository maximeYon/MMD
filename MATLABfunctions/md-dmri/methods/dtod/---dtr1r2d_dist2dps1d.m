function dps1d = dtr1r2d_dist2dps1d(dtr1r2d)
% dps1d = dtr1r2d_dist2dps1d(dtr1r2d)
%
...
%
% Input arguments
% dtr1r2d: diffusion tensor distribution
%
% Output
...
if n > 0
    ...
    dtr1r2d_nx21 = tm_1x6_to_1x21(dtr1r2d_nx6);
    dps1d.ct1x21 = (dtr1r2d_nx21'*w)'/s0 - dt1x21;
