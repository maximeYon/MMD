function mplot_r1r2w_bias(method, dps, slices_path, clim, opt)
% function mplot_r1r2w_bias(method, dps, slices_path, clim, opt)
...
%     plotfields.bin = {'mdiso';'msddelta';'mr1';'mr2'};
    ...
    position.left_v =   [0    1.5 2.5 3.5 4.5 1.5 2.5 3.5 4.5 1.5 2.5 3.5 4.5 7   8   7   8   7   ...
...
elseif strcmp(method,'dtr1r2d')
    ...
    plotfields.hotcold = {
        'mdiso_tr999999_te000000';'mdiso_tr004000_te000000';'mdiso_tr002000_te000000';'mdiso_tr001000_te000000';...
        'mdiso_tr999999_te000025';'mdiso_tr004000_te000025';'mdiso_tr002000_te000025';'mdiso_tr001000_te000025';...
        'mdiso_tr999999_te000050';'mdiso_tr004000_te000050';'mdiso_tr002000_te000050';'mdiso_tr001000_te000050';...
        'mdiso_tr999999_te000100';'mdiso_tr004000_te000100';'mdiso_tr002000_te000100';'mdiso_tr001000_te000100';...
        'msddelta_tr999999_te000000';'msddelta_tr004000_te000000';'msddelta_tr002000_te000000';'msddelta_tr001000_te000000';...
        'msddelta_tr999999_te000025';'msddelta_tr004000_te000025';'msddelta_tr002000_te000025';'msddelta_tr001000_te000025';...
        'msddelta_tr999999_te000050';'msddelta_tr004000_te000050';'msddelta_tr002000_te000050';'msddelta_tr001000_te000050';...
        'msddelta_tr999999_te000100';'msddelta_tr004000_te000100';'msddelta_tr002000_te000100';'msddelta_tr001000_te000100';...
        };
    
    for c = 1:(numel(plotfields.hotcold)/2)
        clim.(plotfields.hotcold{c}) = .2*max(clim.mdiso)*[-1 1];
        dps.(plotfields.hotcold{c}) = dps.(plotfields.hotcold{c}) - dps.mdiso;
    end
    for c = (numel(plotfields.hotcold)/2+1):numel(plotfields.hotcold)
        clim.(plotfields.hotcold{c}) = .2*max(clim.msddelta)*[-1 1];
        dps.(plotfields.hotcold{c}) = dps.(plotfields.hotcold{c}) - dps.msddelta;
    end
    ...
    [grid_left, grid_bottom] = ndgrid(0.5+(0:3),0.25+(0:3));
    position.left_v =   [grid_left(:); 4.5+grid_left(:)]/Ncolumns;
    position.bottom_v = [grid_bottom(:); grid_bottom(:)]/Nrows;
end
