...
if strcmp(method,'dtor1r2d')
    parnams_struct.means = {'mdiso';'msddelta';'mr1';'mr2'};
...
%     parnams_struct.covs = {'cvdisosddelta';'cvdisor1';'cvdisor2';'cvsddeltar1';'cvsddeltar2';'cvr1r2'};
    ...
    parnams.dnus = {'dmdisodnu';'dmsddeltadnu';'dvdisodnu';'dvsddeltadnu';'dcvdisosddeltadnu'};
...
Nparam = max([numel(parnams_struct.means) numel(parnams_struct.vars) numel(parnams_struct.covs)]);
Nrow = numel(statnams);
...
if ~isempty(fig_fn)
    ...
    save(fullfile(fileparts(fig_fn),'hists'),'hists_struct')
end
