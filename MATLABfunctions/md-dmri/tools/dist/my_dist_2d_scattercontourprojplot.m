function [hax,hscatter,hcontour,hprojx,hprojy,wprojx,wprojy] = my_dist_2d_scattercontourprojplot(hax,hax_projx,hax_projy,dist_d,contourpars,axpars,max_projXY)
...
xticks([0 0.5 1 1.5 2 2.5 3 3.5 4 4.5]);
