function [hax,hscatter,hcontour,hprojx,hprojy,wprojx,wprojy] = my_dist_2d_scattercontourprojplot_simplified(hax,hax_projx,hax_projy,dist_d,contourpars,axpars,max_projXY,my_yticks,xticks_yes,yticks_yes)
